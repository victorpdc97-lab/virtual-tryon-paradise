...
export async function loadCategoryMap(): Promise<void> {
  ...
  const orderedKeywords: Array<[GarmentCategory, string[]]> = [
    ["tops", ["blazer", "camis", "blus", "top", "moleton", "jaqueta", "casaco", "camisa", "camiseta", "regata", "cropped", "polo", "colete", "sueter", "suéter", "fitness", "tech", "oversize", "manga", "sobreposição", "sobreposicao", "sobreposições", "sobreposicoes"]],
